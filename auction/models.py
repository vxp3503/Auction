...
class User(AbstractUser):
    watchlist= models.ManyToManyField("Listing",blank=True, related_name="watclist")
    pass
...
class Listing(models.Model):
    ...
    category = models.CharField(max_length=200, verbose_name="Category", blank=True, null=True, choices=category_choice)
...
class Comment(models.Model):
    ...
    date = models.DateTimeField(default=datetime.datetime.now)
    listing = models.ForeignKey(Listing, on_delete = models.CASCADE, related_name="current_comment")
